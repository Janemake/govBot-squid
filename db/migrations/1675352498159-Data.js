module.exports = class Data1675352498159 {
    name = 'Data1675352498159'
    ...
    async up(db) {
        ...
        await db.query(`CREATE TABLE "proposals" ("id" character varying NOT NULL, "title_proposals" text, "deposit" numeric, "start_date" TIMESTAMP WITH TIME ZONE, "last_update_date" TIMESTAMP WITH TIME ZONE, "proposal_hash" text NOT NULL, "nb_seconder" integer, "startblock_height" integer, "last_updateblock_height" integer, "type_vote" text, "status_proposals" text, "prop_creator_id" character varying, CONSTRAINT "PK_db524c8db8e126a38a2f16d8cac" PRIMARY KEY ("id"))`)
        await db.query(`CREATE INDEX "IDX_1cee8f26187d6ede074aef9c87" ON "proposals" ("prop_creator_id") `)
        await db.query(`CREATE UNIQUE INDEX "IDX_626b9e0c7c76889d0e575ea4d5" ON "proposals" ("proposal_hash") `)
        ...
        await db.query(`CREATE TABLE "treasury_proposals" ("id" character varying NOT NULL, "title_proposals" text, "amount" numeric, "slash_amount" numeric, "start_date" TIMESTAMP WITH TIME ZONE, "end_date" TIMESTAMP WITH TIME ZONE, "proposal_hash" text NOT NULL, "startblock_height" integer, "endblock_height" integer, "motion_hash" text, "motion_type" text, "status" text, "prop_creator_id" character varying, "beneficiary_id" character varying, CONSTRAINT "PK_46890ff96ee49457290b4d46357" PRIMARY KEY ("id"))`)
        ...
        await db.query(`CREATE UNIQUE INDEX "IDX_c911bf7c44392bb732cfac707d" ON "treasury_proposals" ("proposal_hash") `)
        await db.query(`CREATE TABLE "motions_votes" ("id" character varying NOT NULL, "motion_hash" text NOT NULL, "approve" text, "nb_ayes" integer, "nb_nay" integer, "event_hash" text, "last_update_date" TIMESTAMP WITH TIME ZONE, "startblock_height" integer, "last_updateblock_height" integer, "motions_id_id" character varying, "member_address_id" character varying, CONSTRAINT "PK_ca47023215ec85302d2a5ac5149" PRIMARY KEY ("id"))`)
        await db.query(`CREATE UNIQUE INDEX "IDX_2346d3d917a5d8c6ee97f93a41" ON "motions_votes" ("motion_hash") `)
        ...
        await db.query(`CREATE TABLE "council_motions" ("id" character varying NOT NULL, "title_motions" text, "start_date" TIMESTAMP WITH TIME ZONE, "end_date" TIMESTAMP WITH TIME ZONE, "startblock_height" integer, "endblock_height" integer, "proposal_hash" text NOT NULL, "proposal_source" text, "threshold" integer, "status" text, "prop_creator_id" character varying, CONSTRAINT "PK_4b6b85730de7712d35c307509f7" PRIMARY KEY ("id"))`)
        await db.query(`CREATE INDEX "IDX_23250abe555a8dbabeeb689f14" ON "council_motions" ("prop_creator_id") `)
        await db.query(`CREATE UNIQUE INDEX "IDX_e78f72300974567b1b2790150d" ON "council_motions" ("proposal_hash") `)
        ...
        await db.query(`CREATE TABLE "tech_com_proposals" ("id" character varying NOT NULL, "title_proposals" text, "threshold" text, "start_date" TIMESTAMP WITH TIME ZONE, "last_update_date" TIMESTAMP WITH TIME ZONE, "proposal_hash" text NOT NULL, "proposal_source" text, "startblock_height" integer, "last_updateblock_height" integer, "status_proposals" text, "prop_creator_id" character varying, CONSTRAINT "PK_de595bc332125875d1ab80ae520" PRIMARY KEY ("id"))`)
        await db.query(`CREATE INDEX "IDX_08fd58f7fdd4a19b548e4b6dbf" ON "tech_com_proposals" ("prop_creator_id") `)
        await db.query(`CREATE UNIQUE INDEX "IDX_cd454077e175fbb1387e78915a" ON "tech_com_proposals" ("proposal_hash") `)
        await db.query(`CREATE TABLE "bounties_proposals" ("id" character varying NOT NULL, "reason" text, "bounty_amount" numeric, "bounty_hash" text NOT NULL, "start_date" TIMESTAMP WITH TIME ZONE, "last_update_date" TIMESTAMP WITH TIME ZONE, "startblock_height" integer, "last_updateblock_height" integer, "status_bounties" text, "prop_creator_id" character varying, "beneficiary_id" character varying, "curator_id" character varying, CONSTRAINT "PK_912395d45bdd8a4ef8312fd86d9" PRIMARY KEY ("id"))`)
        ...
        await db.query(`CREATE UNIQUE INDEX "IDX_3fbdb30173a3d4ac84b4e4dfb8" ON "bounties_proposals" ("bounty_hash") `)
    ...
    async down(db) {
        ...
        await db.query(`DROP INDEX "public"."IDX_626b9e0c7c76889d0e575ea4d5"`)
        ...
        await db.query(`DROP INDEX "public"."IDX_c911bf7c44392bb732cfac707d"`)
        await db.query(`DROP TABLE "motions_votes"`)
        await db.query(`DROP INDEX "public"."IDX_2346d3d917a5d8c6ee97f93a41"`)
        ...
        await db.query(`DROP INDEX "public"."IDX_e78f72300974567b1b2790150d"`)
        ...
        await db.query(`DROP INDEX "public"."IDX_cd454077e175fbb1387e78915a"`)
        ...
        await db.query(`DROP INDEX "public"."IDX_3fbdb30173a3d4ac84b4e4dfb8"`)
